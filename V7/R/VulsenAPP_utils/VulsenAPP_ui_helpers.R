    ...
    div(
      ...
      div(
        ...
        sec_control_section(
          ...
          selectInput(ns(paste0(prefix, "_default_x_rotation")), "X-Axis Label Rotation", choices = c(0, 30, 45, 60, 90), selected = default_x_rotation, width = "110px"),
  ...
  div(
    ...
    div(
      ...
      sec_control_section(
        ...
        selectInput(ns(paste0(prefix, "_x_rotation_", safe_key)), "X-Axis Label Rotation", choices = c(0, 30, 45, 60, 90), selected = default_x_rotation, width = "110px"),
