...
# Remove hardcoded PERIL_CHOICES and SUBPERIL_CHOICES.
# The dropdowns will be populated from peril_lookup() in the server.
PERIL_CHOICES <- names(peril_lookup())
# SUBPERIL_CHOICES is no longer a static vector; the server updates it dynamically.
