      ...
      shiny::div(
        ...
        shiny::div(
          ...
          shiny::div(
            ...
            # Subperil choices are now dynamically populated by the server
          ...
          shiny::div(
            ...
            # Only CSV files are accepted now
        ...
        shiny::div(
          ...
          # The status_ui is now hidden (Problem 1)
          ...
          shiny::tabsetPanel(
            ...
            shiny::tabPanel(
              ...
              shiny::br(),
              # Metadata display (Problem 5)
              shiny::uiOutput(ns("processed_metadata")),
              DT::DTOutput(ns("processed_table"))
            ),
            # The "Notes" tab has been removed (Problem 6)
            shiny::tabPanel(
              title = "Regionwise",
              shiny::br(),
