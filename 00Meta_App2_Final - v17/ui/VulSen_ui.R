      ...
      shiny::div(
        ...
        shiny::div(
          ...
          shiny::div(
            ...
            shiny::selectInput(ns("model_family"), "Vendor model family", choices = VENDOR_CHOICES, selected = "moody", width = "100%", selectize = FALSE),
            shiny::selectInput(ns("n_models"), "Number of model versions", choices = N_MODEL_CHOICES, selected = "1", width = "100%", selectize = FALSE),
            ...
            shiny::selectInput(ns("peril"), "Peril", choices = PERIL_CHOICES, selected = "SCS", width = "100%", selectize = FALSE),
          ...
          shiny::div(
            ...
            shiny::fileInput(ns("file"), "Upload location AAL file (.csv)", accept = ".csv"),
        ...
        shiny::div(
          ...
          shiny::div(
            ...
            shiny::p("This module enables review of Vulnerability Sensitivity outputs from Moody's and Verisk model environments. Uploaded comparison files are processed into standardized heatmap galleries and legend-driven visualisations for model evaluation and validation purposes."),
            shiny::tags$ul(
              shiny::tags$li("Supports Moody's and Verisk vulnerability sensitivity comparison files."),
