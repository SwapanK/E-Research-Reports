...
## -----------------------------------------------------------------------
## Render a ggplot object to a base64 PNG data URI
## Now uses custom width/height if provided
## -----------------------------------------------------------------------
...
cart_server <- function(input, output, session, cart, username) {
  ...
  ## =========================================================================
  ## REMOVE ITEM (session only – no save_cart)
  ## =========================================================================
  ...
  ## =========================================================================
  ## GENERATE REPORT – uses temp RDS file
  ## =========================================================================
      ...
      tryCatch({
        switch(
          ...
          "pptx" = generate_cart_ppt(
            cart_path   = temp_cart,
            output_path = file,
            username    = username   # <-- FIX: pass character directly, not as function
          ),
