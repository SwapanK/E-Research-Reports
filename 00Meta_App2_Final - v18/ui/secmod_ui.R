...
sec_plot_card_gallery <- function(ns, key, label, prefix,
                                  ...
                                  default_axis_text_hjust = 1,
                                  default_axis_wrap_width = 30) {
  ...
  div(
    ...
    div(
      ...
      sec_control_section(
        ...
        numericInput(ns(paste0(prefix, "_axis_text_hjust_", key)), "X label hjust", value = default_axis_text_hjust, min = 0, max = 1, step = 0.05, width = "80px"),
        numericInput(ns(paste0(prefix, "_axis_wrap_width_", key)), "X-tick wrap width", value = default_axis_wrap_width, min = 5, max = 60, step = 1, width = "80px")
      ),
    ...
    div(
      ...
      div(
        ...
        sec_control_section(
          ...
          numericInput(ns(paste0(prefix, "_default_axis_text_hjust")), "X label hjust", value = default_axis_text_hjust, min = 0, max = 1, step = 0.05, width = "80px"),
          numericInput(ns(paste0(prefix, "_default_axis_wrap_width")), "X-tick wrap width", value = default_axis_wrap_width, min = 5, max = 60, step = 1, width = "80px")
        ),
