  ...
  div(
    ...
    div(
      ...
      sec_control_section(
        ...
        numericInput(ns(paste0(prefix, "_strip_text_", key)), "LOB text size", value = default_strip_text, min = 6, max = 30, step = 1, width = "80px")
      ),
      # ---- 2. Axis Properties ----
      sec_control_section(
        "Axis Properties",
      ...
      sec_control_section(
        "Color Properties",
        div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_col_sfd_", key)), "SFD", value = default_col_sfd, showColour = "both", width = "80px")),
        div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_col_com_", key)), "COM", value = default_col_com, showColour = "both", width = "80px")),
        div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_col_pen_", key)), "Penalty", value = default_col_pen, showColour = "both", width = "80px")),
        div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_col_cred_", key)), "Credit", value = default_col_cred, showColour = "both", width = "80px"))
      ),
    ...
    div(
      ...
      div(
        ...
        sec_control_section(
          ...
          numericInput(ns(paste0(prefix, "_default_strip_text")), "LOB text size", value = default_strip_text, min = 6, max = 30, step = 1, width = "80px")
        ),
        ...
        sec_control_section(
          "Color Properties",
          div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_default_col_sfd")), "SFD", value = default_col_sfd, showColour = "both", width = "80px")),
          div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_default_col_com")), "COM", value = default_col_com, showColour = "both", width = "80px")),
          div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_default_col_pen")), "Penalty", value = default_col_pen, showColour = "both", width = "80px")),
          div(class = "sec2-swatch-field", colourInput(ns(paste0(prefix, "_default_col_cred")), "Credit", value = default_col_cred, showColour = "both", width = "80px"))
        ),
