...
sec_plot_card_gallery <- function(ns, key, label, prefix,
                                  ...
                                  default_axis_text_margin_t = 5, default_axis_text_vjust = 0.5) {
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          # "Apply to all" second (right side)
      ...
      div(
        ...
        div(
          ...
          div(
            ...
            # ---- Colour pickers: PLAIN SHINY DEFAULTS, but full width ----
            colourInput(ns("sec_color_sfd"), "SFD color", value = "#6FACDE", showColour = "both", width = "100%"),
            colourInput(ns("sec_color_com"), "COM color", value = "#F0B323", showColour = "both", width = "100%"),
            colourInput(ns("sec_color_max"), "Penalty color", value = "#F0B323", showColour = "both", width = "100%"),
            colourInput(ns("sec_color_min"), "Credit color", value = "#6FACDE", showColour = "both", width = "100%"),
          ...
          # ---- Section 3: Credit / Penalty (title updated) ----
          div(
          ...
          # ---- Section 4: State Sensitivity (title updated) ----
          div(
