...
# =============================================================================
# Mirrors the MetaApp "home_ui.R" pattern: hero banner + description panel +
# feature cards that deep-link into each analytics page via updateTabItems().
# =============================================================================
    ...
    div(
      ...
      div(
        ...
        div(
          ...
          div(class = "home-section-title", "Analytics modules"),
          div(class = "home-section-sub",
              "Use the sidebar filters to set state, loss perspective, line of business, ",
              "and subperils \u2014 they apply across every module below.")
        ),
