...
vul_default_overrides <- function(group = c("region", "state", "pct")) {
  ...
  by_group <- switch(
    group,
    region = list(axis_text = 12, plot_title = 16, strip_text = 12),
    state  = list(axis_text = 10, plot_title = 14, strip_text = 10),
    pct    = list(axis_text = 12, plot_title = 16, strip_text = 12)
  )
