    ...
    div(
      ...
      div(
        ...
        div(
          ...
          div(class = "home-hero-eyebrow", icon("shield-alt"), "MODEL TESTING WORKSPACE"),   # changed from shield-halved
          h1(class = "home-hero-title", "Vulnerability Module Analytics"),                  # single line
          ...
          div(
            ...
            div(class = "home-stat", div(class = "home-stat-num", "3"), div(class = "home-stat-label", "Test modules")),
            div(class = "home-stat-divider"),
      ...
      div(
        ...
        div(
          ...
          home_feature_card(ns, "go_vulsen_card",
                            "chart-column",
                            "Vulnerability Sensitivity",
                            "Compare Moody's RMS and Verisk vulnerability curves across regions, states, and model versions with a configurable legend gallery.",
                            "Moody's · Verisk", "purple"),
          home_feature_card(ns, "go_secmod_card",
                            "shield-alt",                     # changed from shield-halved
                            "Secondary Modifier",
      ...
      div(
        ...
        div(class = "home-footer-text", "Vulnerability Module Analytics — internal model testing workspace")
      )
    )
  )
}