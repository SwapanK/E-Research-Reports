...
#     output_file = "MetaApp_combined_code_v14.txt"
#   )
# }
#
#
...
#   output_file = "MetaApp_architecture_v14.txt",
...
result <- combine_code_with_prompt(
  parent_folder = folder_path,
  output_file = "USTCFL_combined_app.txt",
  file_types = c("r", "R", "Rmd", "json", "css", "js", "sh"),
  quiet = FALSE
)
