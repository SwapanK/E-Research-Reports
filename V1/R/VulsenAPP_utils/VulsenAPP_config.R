...
REL_BREAKS <- c(0,0.5,0.8,0.95,1.05,1.2,1.5,2,5,505)
REL_INTERVALS <- c("0 - 0.5","0.5 - 0.8","0.8 - 0.95","0.95 - 1.05","1.05 - 1.2","1.2 - 1.5","1.5 - 2","2 - 5",">5")
PCT_BREAKS <- c(-100,-50,-25,-10,0,10,25,50,100,1000)
...
PCT_COLORS <- c("#003B5E", "#0075BC", "#3795BF", "#4AA57F", "#898D8D", "#F0B323", "#C18C0D", "#E07E3C", "#7B3D13")
...
# Model-1 is always the "new" / primary version; Model-2 (only used when
# the user selects 2 model versions) is the "old" / comparison version.
