...
# -----------------------------------------------------------------------------
# Plot card (with namespace support)
# -----------------------------------------------------------------------------
...
vul_gallery_controls_ui <- function(
    ...
    default_grid_col = "white",
    default_tile_border_lwd = 0.22,
    ...
    div(
      ...
      div(
        ...
        sec_control_section(
          ...
          colourInput(ns(paste0(prefix, "_default_grid_col")), "Tile border colour", value = default_grid_col, showColour = "text", width = "80px"),
          numericInput(ns(paste0(prefix, "_default_tile_border_lwd")), "Tile border width", value = default_tile_border_lwd, min = 0, max = 2, step = 0.05, width = "80px"),
          colourInput(ns(paste0(prefix, "_default_border_col")), "Panel border colour", value = default_border_col, showColour = "text", width = "80px"),
          numericInput(ns(paste0(prefix, "_default_border_lwd")), "Panel border lwd", value = default_border_lwd, min = 0, max = 5, step = 0.1, width = "80px")
        ),
  ...
  div(
    ...
    div(
      ...
      sec_control_section(
        ...
        colourInput(ns(paste0(prefix, "_grid_col_", key)), "Tile border colour", value = default_grid_col, showColour = "text", width = "80px"),
        numericInput(ns(paste0(prefix, "_tile_border_lwd_", key)), "Tile border width", value = default_tile_border_lwd, min = 0, max = 2, step = 0.05, width = "80px"),
        colourInput(ns(paste0(prefix, "_panel_border_col_", key)), "Panel border colour", value = default_border_col, showColour = "text", width = "80px"),
        numericInput(ns(paste0(prefix, "_panel_border_lwd_", key)), "Panel border lwd", value = default_border_lwd, min = 0, max = 5, step = 0.1, width = "80px")
      ),
